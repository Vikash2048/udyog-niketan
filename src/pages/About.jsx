...
const About = () => {
  return (
    <div id='About' className='h-[60%] w-full bg-[#f8f7f700] md:pt-24 md:py-0 py-20 px-10 flex md:flex-row flex-col justify-center relative gap-8'>
      ...
      <div className='md:w-[40%] h-[85%] flex flex-col md:pt-10  gap-4'>
